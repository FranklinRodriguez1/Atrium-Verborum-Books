...
export default function ShopCarPage() {
  return (
    <div className="min-h-screen bg-[#f8f9fb] text-[#0c1018]">
      <header className="border-b border-zinc-200/70 bg-white/95 backdrop-blur">
        <div className="mx-auto flex h-[76px] w-full max-w-[1440px] items-center justify-between gap-4 px-5 sm:px-7">
          <a
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 pb-24 pt-8 sm:px-7 md:px-10 lg:px-[42px]">
      <div className="grid gap-8 lg:grid-cols-12">
        <section className="lg:col-span-7 xl:col-span-8">
          <a
            href="/client/bookStore"
