...
const navItems = [
  { label: "Dashboard", icon: "grid", href: "/client/dashboard" },
  { label: "Book Store", icon: "book", href: "/client/bookStore" },
  { label: "Shop Cart", icon: "cart", href: "/client/shopcar" },
  { label: "Locations", icon: "map", href: "/client/locations" },
